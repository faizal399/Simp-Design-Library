...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div className="h-fit">
        <h1 className="bg-gradient-to-r  from-purple-400  to-indigo-500 bg-clip-text text-transparent h-full pb-2 md:text-8xl text-5xl text-center relative z-30 font-bold">
      ...
      <button
        ...
        className="mt-8 px-8 py-3 rounded-full bg-gradient-to-r from-purple-500 to-indigo-600 hover:scale-105 transition-all duration-300 font-medium shadow-lg cursor-pointer shadow-purple-500/30"
      >
        Explore Components
      </button>
    </div>
